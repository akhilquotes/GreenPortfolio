...
const host = "http://13.230.186.196:5000"; // "http://localhost:5000"; // ;
const companyWallet = "ewallet_0c713d827b7767085f558a2331f1587e";
// const getImg = () => {
//   let base64 = "";
//   imageToBase64("/Face.png").then((res) => {
//     base64 = res;
//   });
//   return base64;
// };
export function RapydContextProvider({ children }) {
  ...
  async function createSender(user, currency) {
    try {
      const body = {
        country: user.Country,
        currency: currency,
      ...
      const response = await fetch(`${host}/rapyd/createSender`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  async function retrieveSender(sender) {
    try {
      const response = await fetch(
        `${host}/rapyd/retrieveSender?sender=${sender}`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
  ...
  async function listPayoutMethods(
    country,
    senderCurrency,
    beneficiaryCurrency
  ) {
    try {
      const response = await fetch(
        `${host}/rapyd/listPayoutMethods?country=${country}&senderCurrency=${senderCurrency}&payoutCurrency=${beneficiaryCurrency}&category=bank`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
  ...
  async function listPayoutMethodFields(
    payoutMethod,
    country,
    senderCurrency,
    beneficiaryCurrency,
    ...
    try {
      const response = await fetch(
        `${host}/rapyd/listPayoutMethodFields?payoutMethod=${payoutMethod}&country=${country}&senderCurrency=${senderCurrency}&beneficiaryCurrency=${beneficiaryCurrency}&amount=${amount}`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
